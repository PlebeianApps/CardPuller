...
@interface CardPullerObject : KrollCoverageObject {
#else
@interface CardPullerObject : KrollObject {
#endif
@private
...
extern NSString * CardPuller$ModuleRequireFormat;
