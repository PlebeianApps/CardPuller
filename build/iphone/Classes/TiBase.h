...
// in simulator we redefine to format for CardPuller Developer console
...
{\
	NSString * exceptionName = [@"org.cardpuller." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cardpuller";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UICardPullerNativeItemNone = -1, 
	UICardPullerNativeItemSpinner = -2,
	UICardPullerNativeItemProgressBar = -3,
	
	UICardPullerNativeItemSlider = -4,
	UICardPullerNativeItemSwitch = -5,
	UICardPullerNativeItemMultiButton = -6,
	UICardPullerNativeItemSegmented = -7,
	
	UICardPullerNativeItemTextView = -8,
	UICardPullerNativeItemTextField = -9,
	UICardPullerNativeItemSearchBar = -10,
	
	UICardPullerNativeItemPicker = -11,
	UICardPullerNativeItemDatePicker = -12,
	
	UICardPullerNativeItemInfoLight = -13,
	UICardPullerNativeItemInfoDark = -14,
	
	UICardPullerNativeItemDisclosure = -15,
	
	UICardPullerNativeItemContactAdd = -16
};
